...
$nic2 = "";
$cover = ""; -->
<title>Constructor Profile</title>
<?php $id = 0 ?>
...
<body>
  ...
  if (isset($email)) {
    ...
    $query = "SELECT * FROM `constructor` WHERE `email` = '{$email}' ";
  ...
  <form action="cProfile.php" method="post" enctype="multipart/form-data">
    <div class="container2">
      ...
      <label> Email: </label>
      <input value="<?php echo $email; ?>" disabled type="text" name="email" placeholder="Email" size="5" required>
